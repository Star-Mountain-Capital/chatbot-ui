            ...
            >
              {showHardCodedData ? (
                <>
                  ...
                  <div>
                    Lacus mauris auctor nulla in congue non dolor a aliquam.
                    Congue risus arcu in netus convallis sapien blandit. Ac
                    sodales quisque vel fringilla ut neque praesent. Ac velit
                    tortor ac diam. Duis porta facilisis aliquam lorem lacus
                    morbi laoreet adipiscing.
                  </div>
                  <ul>
                    <li className="flex pb-1.5">
                      <DotIcon />
                      Lorem ipsum dolor sit amet consectetur
                    </li>
                    <li className="flex pb-1.5">
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell>Table Cell Text</TableCell>
                        <TableCell>Table Cell Text</TableCell>
                        <TableCell>Table Cell Text</TableCell>
                        <TableCell>Table Cell Text</TableCell>
                      </TableRow>
                  ...
                  <div className="bg-card border-border rounded-lg border">
                    <div className="text-muted-foreground border-b-border flex justify-between border-b px-6 py-3.5">
                      <div className="leading-none">Heading</div>
                      <a
                    ...
                    <div className="p-6">
                      <div className="mb-1 text-lg font-medium">Line Chart</div>
                  ...
                  <div className="bg-card border-border rounded-lg border">
                    <div className="text-muted-foreground border-b-border flex justify-between border-b px-6 py-3.5">
                      <div className="leading-none">Budget Adjusted EBITDA</div>
                      <a
                        className="flex items-center gap-x-2"
                        href="https://google.com"
                        rel="noreferrer noopener"
                    ...
                    <div className="p-6">
                      <div className="mb-5 flex items-end gap-x-2">
                        <div className="text-4xl font-medium">$7,051.40</div>
                        <div className="text-muted-foreground text-lg">USD</div>
                      </div>
                      ...
                      <div className="text-muted-foreground flex items-center gap-x-1.5">
                        ...
                        <div className="leading-none">January 10, 2025</div>
                      </div>
                    </div>
                  </div>
                  <div className="pt-2">
                            ...
                            >
                              ...
                              <div className="bg-alpha-60 hover:bg-alpha-40 mb-2 rounded-sm p-3">
                                ...
                                <div className="text-muted-foreground line-clamp-2 w-[373px] text-sm font-light">
                                  ...
                                  sem egestas egestas molestie. Condimentum non
                                  pulvinar in nec tempus arcu sapien egestas
                                  ullamcorper. Vulputate sed vel ultrices vitae
                                  quis nisl. Magna habitant adipiscing mollis
                                  tristique proin nibh. A turpis ullamcorper
                                  adipiscing elementum ullamcorper. Penatibus
                                  bibendum diam eget tempor. Sed sit iaculis
                                  sagittis pellentesque in. Auctor etiam vivamus
                                  mattis vel. Turpis feugiat pellentesque risus
